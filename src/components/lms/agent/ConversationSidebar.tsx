...
>(function ConversationSidebar(
  ...
  return (
    ...
    >
      ...
      <div className="p-3.5 border-b border-slate-200/80 dark:border-blue-500/10 bg-slate-50/50 dark:bg-[#070E1C] flex items-center gap-2 flex-shrink-0">
        <button
        ...
        {onCloseMobile && (
          <button
            ...
            className="lg:hidden p-2 rounded-xl border border-slate-200 dark:border-blue-500/15 hover:bg-slate-100 dark:hover:bg-[#162644] text-slate-500 dark:text-slate-400 transition-all duration-200 active:scale-95 flex-shrink-0 cursor-pointer"
