...
export const DEPARTMENT_OPTIONS = [
  {
    ...
    taglineVi: "Phát triển Hệ thống, AI Agents & Hạ tầng Dữ liệu lớn",
    taglineEn: "Systems, AI Agents & Big Data Infrastructure",
    descriptionVi:
      "Làm chủ mã nguồn sản phẩm thực tế của BDC, vận hành trên Cluster GPU riêng và giải quyết bài toán xử lý dữ liệu quy mô lớn.",
    descriptionEn:
      "Own production codebase for real BDC products, deploy on private GPU clusters, and tackle large-scale data engineering challenges.",
    fitTitleVi: "Bạn sẽ tỏa sáng tại Ban R&D nếu:",
    fitTitleEn: "You'll thrive in R&D if you:",
    highlightsVi: [
      "Thích viết code thực chiến (Web App, AI Pipelines, System Design) thay vì chỉ học lý thuyết.",
      "Muốn tiếp cận trực tiếp hạ tầng GPU Server & thử nghiệm các mô hình AI/RAG tiên tiến.",
      "Khao khát tìm kiếm Mentor 1:1 là các Senior Software/Data Engineer dày dặn kinh nghiệm.",
    ],
    highlightsEn: [
      "Love hands-on coding (Web Apps, AI Pipelines, Systems) beyond university lectures.",
      "Want direct access to GPU server infrastructure to build and deploy advanced AI models.",
      "Seek 1:1 Mentorship from senior engineering alumni working in tech industry.",
    ],
  ...
  },
  {
    ...
    taglineVi: "Sáng tạo Nội dung, Thiết kế Thương hiệu & Vận hành Sự kiện",
    taglineEn: "Content Creation, Visual Design & Tech Event Operations",
    descriptionVi:
      "Biến những ý tưởng công nghệ phức tạp thành câu chuyện truyền cảm hứng và trực tiếp đứng sau sự thành công của các Hackathon & Workshop quy mô lớn.",
    descriptionEn:
      "Turn complex tech concepts into engaging stories and power major student Hackathons, Workshops & Community events.",
    fitTitleVi: "Bạn sẽ tỏa sáng tại Ban Community nếu:",
    fitTitleEn: "You'll thrive in Community if you:",
    highlightsVi: [
      "Đam mê thiết kế đồ họa (Figma/Photoshop), quay dựng video hoặc sáng tạo content công nghệ.",
      "Thích đứng sau tổ chức các sự kiện quy mô hàng trăm sinh viên và mở rộng mạng lưới kết nối.",
      "Muốn rèn luyện tư duy Marketing, vận hành truyền thông đa kênh cho một thương hiệu CLB lớn.",
    ],
    highlightsEn: [
      "Are passionate about graphic design, video editing, or tech content creation.",
      "Enjoy organizing large-scale tech events and building strong community networks.",
      "Want to master event management, branding, and social media growth strategies.",
    ],
...
export const T = {
  vi: {
    ...
    motivationLabel: "Điều bạn mong muốn nhận được hoặc đóng góp khi vào BDC? *",
    motivationHint: "Chia sẻ thẳng thắn suy nghĩ của bạn. Bạn có thể bấm chọn các chủ đề bên dưới để làm gợi ý:",
    motivationPh: "Ví dụ: Em muốn làm dự án AI thực tế để có thêm sản phẩm đưa vào CV, đồng thời muốn quen thêm nhiều anh chị đi trước trong ngành...",
    motivationChipsLabel: "Gợi ý chủ đề nhanh:",
    motivationChips: [
      "Làm dự án AI / Web thực tế",
      "Dùng thử Server GPU của CLB",
      "Được anh chị Senior hướng dẫn",
      "Tổ chức sự kiện & Hackathon",
      "Thiết kế / Sáng tạo nội dung",
      "Tìm bạn bè cùng học Lập trình",
    ],
  ...
  en: {
    ...
    motivationLabel: "What do you hope to gain or contribute upon joining BDC? *",
    motivationHint: "Share your honest thoughts. Tap on any suggested topics below for quick inspiration:",
    motivationPh: "e.g., I want to build real AI projects to strengthen my CV and meet passionate tech peers and seniors...",
    motivationChipsLabel: "Quick Topic Suggestions:",
    motivationChips: [
      "Building Real AI/Web Projects",
      "Hands-on GPU Server Access",
      "Senior Alumni Mentorship",
      "Organizing Events & Hackathons",
      "UI/Branding & Tech Content",
      "Finding Study & Coding Partners",
    ],
