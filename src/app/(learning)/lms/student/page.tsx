...
export default function StudentDashboard() {
  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      {/* ── Header ── */}
      <div className="flex items-start justify-between gap-6 flex-wrap pb-6 border-b border-slate-200 dark:border-blue-500/10">
        <div className="min-w-0 flex-1 max-w-xl">
          ...
          <div className="mt-4">
            <GhostBtn
              ...
              onClick={loadAllData}
              className="hover:scale-[1.02] active:scale-95 border border-slate-200 dark:border-slate-800"
            >
              Làm mới dữ liệu
            </GhostBtn>
          </div>
        ...
        <div className="w-full md:w-[450px] flex-shrink-0">
          {selectedCourseId && (
            <SpacedRepetitionWidget courseId={selectedCourseId} />
          )}
        </div>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6 min-w-0">
          ...
          <div className="space-y-4">
            ...
            {loadingEnrolled ? (
              <div className="space-y-4">
                {[0, 1].map(i => (
                  <div key={i} className="h-[120px] bg-white dark:bg-[#0F1E35] rounded-2xl border border-slate-200 dark:border-blue-500/10 animate-pulse" />
                ))}
              </div>
            ) : (
              <div className="space-y-4">
                {/* Hero Card: Hành trình học tập tổng quan */}
                <div className="bg-white dark:bg-[#0F1E35] border border-slate-200 dark:border-blue-500/15 rounded-2xl p-5 shadow-sm hover:border-blue-300 dark:hover:border-blue-500/25 transition-all duration-200">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-blue-50/70 text-blue-600 dark:bg-blue-950/40 dark:text-cyan-400 border border-blue-200/50 dark:border-cyan-500/20">
                      <TrendingUp className="w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-slate-900 dark:text-white">Tiến độ tổng quát</h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">Phân bổ trạng thái khóa học</p>
                    </div>
                  </div>
                  ...
                  {totalCount === 0 ? (
                    ...
                    <>
                      ...
                      <TooltipProvider delayDuration={50}>
                        <div className="h-3 rounded-full overflow-hidden flex bg-slate-100 dark:bg-[#0D192E] mb-4 border dark:border-blue-500/5">
                          {completedCount > 0 && (
                            <UITooltip>
                      ...
                      {/* Legend Details */}
                      <div className="grid grid-cols-3 gap-2 pt-3 border-t border-slate-100 dark:border-blue-500/5">
                        ...
                        <div className="flex flex-col items-center justify-center text-center border-x border-slate-100 dark:border-blue-500/5">
                          <div className="flex items-center justify-center gap-1.5 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
